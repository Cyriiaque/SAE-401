 ...
 */
final class Version20250324093051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post_interaction ADD id_user_id INT NOT NULL, ADD id_post_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post_interaction DROP id_user_id, DROP id_post_id');
    }
}
